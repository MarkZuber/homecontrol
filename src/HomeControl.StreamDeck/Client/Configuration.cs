 ...
 * StreamDeck API
 *
 * API to get images for StreamDeck
 *
...
namespace HomeControl.StreamDeck.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        private static readonly object s_globalConfigSync = new { };
        private static Configuration s_globalConfiguration;
        ...
        {
            get { return s_globalConfiguration; }
            set
            {
                lock (s_globalConfigSync)
                {
                    s_globalConfiguration = value;
                }
            }
        }
        ...
        {
            s_globalConfiguration = new GlobalConfiguration();
        }
